...
$reportFile = "$BaseDir\handoffs\Api_Verification_Report_$fileTimestamp.md"
...
$masterSecrets = "$BaseDir\config\secrets\secrets.json"
...
$scanPaths = @("$BaseDir\config", $ConfigDir, "$BaseDir\musicbrainz-docker\local\secrets")
...
$mbTokenFile = "$BaseDir\musicbrainz-docker\local\secrets\metabrainz_access_token"
