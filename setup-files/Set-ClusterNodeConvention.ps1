...
.DESCRIPTION
    ...
    - Primary 24/7 Primary Server: VoltaireUn (192.168.4.21) [Formerly VOLTAIREUN / voltaireun]
...
$nodeTable = @(
    [PSCustomObject]@{ CanonicalName = "VoltaireUn";    IP = "192.168.4.21"; Role = "Primary 24/7 Primary & DB";  LegacyAliases = "VOLTAIREUN, voltaireun, voltaireun.local" },
