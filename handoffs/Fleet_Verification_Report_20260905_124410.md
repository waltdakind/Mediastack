...
| Containers | Container: caddy | PASS | Status: RUNNING (Started: 2026-09-05T16:25:06.797277568Z) |
...
| HTTP | Caddy Reverse Proxy | PASS | HTTP 301 (TTFB: 3.4ms) |
| HTTP | Jellyfin Stream | PASS | HTTP 307 (TTFB: 3.8ms) |
| HTTP | Sonarr TV Manager | PASS | HTTP 200 (TTFB: 9.3ms) |
| HTTP | Radarr Movies | PASS | HTTP 200 (TTFB: 4.1ms) |
| HTTP | Prowlarr Indexers | PASS | HTTP 200 (TTFB: 108.2ms) |
| HTTP | Bazarr Subtitles | PASS | HTTP 200 (TTFB: 161.7ms) |
| HTTP | Seerr Requests | PASS | HTTP 200 (TTFB: 5.6ms) |
| HTTP | Syncthing P2P Mesh | PASS | HTTP 200 (TTFB: 5.8ms) |
| HTTP | Transmission Web | PASS | HTTP 200 (TTFB: 3.5ms) |
