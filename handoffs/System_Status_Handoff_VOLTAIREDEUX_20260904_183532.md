...
- **Peer LAN IP:** fe80::a161:849b:78cc:574f%13
- **Generated Timestamp:** 2026-09-04 18:35:32
- **Running Fleet Containers:** 20 / 20
...
```
  Node: VOLTAIREDEUX (192.168.4.30) <===> Peer: VOLTAIREUN (fe80::a161:849b:78cc:574f%13)
...
| **sonarr.db** | sonarr | Yes | 2912 KB | [OK] PRISTINE | Integrity Check Passed (2912 KB) |
| **radarr.db** | radarr | Yes | 1188 KB | [WARN] CORRUPT | Integrity Anomaly: Error: in prepare, database disk image is malformed (11) |
| **prowlarr.db** | prowlarr | Yes | 328 KB | [OK] PRISTINE | Integrity Check Passed (328 KB) |
...
| **jellyfin.db** | jellyfin | Yes | 56332 KB | [OK] PRISTINE | Integrity Check Passed (56332 KB) |
