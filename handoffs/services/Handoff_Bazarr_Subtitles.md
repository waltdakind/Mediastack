...
| **Restart Count** | 0 |
| **Container Started** | 2026-08-31T23:38:20.814119918Z |
| **L7 Response Code** | HTTP 200 |
| **TTFB Latency** | 23.1 ms |
...
`	ext
[migrations] started [migrations] no migrations found usermod: no changes ───────────────────────────────────────        ██╗     ███████╗██╗ ██████╗       ██║     ██╔════╝██║██╔═══██╗       ██║     ███████╗██║██║   ██║       ██║     ╚════██║██║██║   ██║       ███████╗███████║██║╚██████╔╝       ╚══════╝╚══════╝╚═╝ ╚═════╝     Brought to you by linuxserver.io ───────────────────────────────────────  To support the app dev(s) visit: Bazarr: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=XHHRWXT9YB7WE&source=url  To support LSIO projects visit: https://www.linuxserver.io/donate/  ─────────────────────────────────────── GID/UID ───────────────────────────────────────  User UID:    1000 User GID:    1000 ─────────────────────────────────────── Linuxserver.io version: v1.6.0-ls359 Build-date: 2026-08-16T14:25:04+00:00 ───────────────────────────────────────      [custom-init] No custom files found, skipping... Bazarr starting child process with PID 162... 2026-08-31 19:38:36,558 - root                             (ff11e5349d20) :  INFO (scheduler:78) - Scheduler will use this timezone: America/New_York Connection to localhost (::1) 6767 port [tcp/*] succeeded! [ls.io-init] done. 2026-08-31 19:38:42,238 - root                             (ff11e5349d20) :  INFO (main:86) - Interactive jobs queue started and waiting for tasks 2026-08-31 19:38:42,239 - waitress                         (ff11e5349d20) :  INFO (wasyncore:449) - BAZARR is started and waiting for requests on: http://***.***.***.***:6767 2026-08-31 19:38:42,240 - waitress                         (ff11e5349d20) :  INFO (wasyncore:449) - BAZARR is started and waiting for requests on: http://[::]:6767
`
