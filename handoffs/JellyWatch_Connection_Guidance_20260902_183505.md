...
- **Timestamp:** 2026-09-02 18:35:05
- **Primary Live Route:** VoltaireUn Direct Socket (Primary LAN) (http://192.168.4.21:8096) - Latency: 1595 ms
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | VoltaireUn Direct Socket (Primary LAN) | http://192.168.4.21:8096 | HTTP/REST | [OK] ONLINE | 1595 ms | Apple Watch on Home WiFi (Zero TLS handshake friction, lowest latency) |
| 2 | VoltaireUn Ingress Gateway (Caddy HTTPS) | https://voltaireun.local | HTTPS/HTTP2 | [!] UNREACHABLE | 1830 ms | LAN Web Companion & Ingress with Caching |
| 3 | VoltaireDeux AI Node (Failover LAN) | http://192.168.4.30:8096 | HTTP/REST | [!] UNREACHABLE | 1812 ms | Automated Failover when VoltaireUn is restarting/updating |
| 4 | Remote WAN Gateway (Public DDNS) | https://waltdakind.xubi.org | HTTPS/WAN | [!] UNREACHABLE | 1833 ms | Apple Watch on LTE/Cellular or Out-of-Home Remote Streaming |
| 5 | Localhost Loopback Socket | http://127.0.0.1:8096 | HTTP/Loopback | [!] UNREACHABLE | 1803 ms | Local Server Diagnostic & Docker Host Testing |
