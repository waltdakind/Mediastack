...
| Parameter | Value |
| :--- | :--- |
| **Audit Timestamp** | 2026-08-29 00:13:21 |
...
| Radarr API | http://localhost:7878/api/v3/system/status | OK | 200 | 34ms | version: 6.3.0.10514 |
| Prowlarr API | http://localhost:9696/api/v1/system/status | FAIL | FAIL | 80ms | The remote server returned an error: (500) Internal Server Error. |
| Bazarr API | http://localhost:6767/api/system/status | OK | 200 | 12ms | HTTP 200 OK |
| Jellyseerr API | http://localhost:5055/api/v1/status | OK | 200 | 2052ms | version: 3.4.1 |
...
| AcoustID API | https://api.acoustid.org/v2/user/lookup?user=4wzgif6hwM | OK | 200 | 2338ms | status: ok |
| API Gateway | http://localhost:3000/api/system/status | OK | 200 | 92ms | HTTP 200 OK |
| SQLite DB Web | http://localhost:8080/ | OK | 200 | 28ms | HTTP 200 OK (HTML/Text) |
