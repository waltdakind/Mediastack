...
| **Jellyseerr Requests** | 5055 | jellyseerr | REQUESTS | **YES** | ONLINE | 11 ms | Operating normally |
| **Transmission Web UI** | 9091 | transmission | TORRENT | **YES** | ONLINE | 0 ms | Operating normally |
| **Transmission Peer TCP** | 51413 | transmission | TORRENT | No | STANDBY | 1213 ms | Standby / optional node service not currently active. |
...
| :--- | :--- | :--- | :--- | :--- |
| **Dashboard Ingress HTTP** | http://voltairedeux.local | 301 OK | 65 ms | HTTP 301 via curl |
| **Dashboard Ingress HTTPS** | https://voltairedeux.local | 302 OK | 62 ms | HTTP 302 via curl |
| **Jellyfin Subdomain HTTP** | http://jellyfin.voltairedeux.local | 301 OK | 66 ms | HTTP 301 (Caddy Gateway Verified) |
| **Jellyfin Subdomain HTTPS** | https://jellyfin.voltairedeux.local | 301 OK | 33 ms | HTTP 301 (Caddy Gateway Verified) |
| **Sonarr Subdomain HTTPS** | https://sonarr.voltairedeux.local | 301 OK | 54 ms | HTTP 301 (Caddy Gateway Verified) |
| **Radarr Subdomain HTTPS** | https://radarr.voltairedeux.local | 301 OK | 50 ms | HTTP 301 (Caddy Gateway Verified) |
| **Prowlarr Subdomain HTTPS** | https://prowlarr.voltairedeux.local | 301 OK | 47 ms | HTTP 301 (Caddy Gateway Verified) |
| **Bazarr Subdomain HTTPS** | https://bazarr.voltairedeux.local | 301 OK | 49 ms | HTTP 301 (Caddy Gateway Verified) |
| **Jellyseerr Route HTTPS** | https://jellyseerr.voltairedeux.local | 301 OK | 62 ms | HTTP 301 (Caddy Gateway Verified) |
| **API Gateway Route HTTPS** | https://api.voltairedeux.local | 308 OK | 50 ms | HTTP 308 (Caddy Gateway Verified) |
| **Database GUI Route HTTPS** | https://db.voltairedeux.local | 301 OK | 51 ms | HTTP 301 (Caddy Gateway Verified) |
...
*Report archived in: C:\Users\waltd\OneDrive\Mediastack\handoffs\Proxy_Port_Diagnostic_Report_20260831_203455.md*
