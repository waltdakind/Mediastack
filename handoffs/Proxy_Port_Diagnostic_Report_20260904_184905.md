...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Caddy Gateway HTTP** | 80 | caddy | INGRESS | **YES** | ONLINE | 10 ms | Operating normally |
...
| **MusicBrainz Secondary** | 5001 | musicbrainz | METADATA | No | ONLINE | 36 ms | Operating normally |
...
| :--- | :--- | :--- | :--- | :--- |
| **Dashboard Ingress HTTP** | http://voltaireun.local | 301 OK | 131 ms | HTTP 301 via curl |
| **Dashboard Ingress HTTPS** | https://voltaireun.local | 302 OK | 99 ms | HTTP 302 via curl |
| **Jellyfin Subdomain HTTP** | http://jellyfin.voltaireun.local | 301 OK | 69 ms | HTTP 301 via curl |
| **Jellyfin Subdomain HTTPS** | https://jellyfin.voltaireun.local | 200 OK | 110 ms | HTTP 200 via curl |
| **Sonarr Subdomain HTTPS** | https://sonarr.voltaireun.local | 401 OK | 166 ms | HTTP 401 via curl |
| **Radarr Subdomain HTTPS** | https://radarr.voltaireun.local | 302 OK | 263 ms | HTTP 302 via curl |
| **Prowlarr Subdomain HTTPS** | https://prowlarr.voltaireun.local | 302 OK | 227 ms | HTTP 302 via curl |
| **Bazarr Subdomain HTTPS** | https://bazarr.voltaireun.local | 200 OK | 201 ms | HTTP 200 via curl |
| **Jellyseerr Route HTTPS** | https://jellyseerr.voltaireun.local | 307 OK | 286 ms | HTTP 307 via curl |
| **API Gateway Route HTTPS** | https://api.voltaireun.local | 308 OK | 128 ms | HTTP 308 (Caddy Gateway Verified) |
| **Database GUI Route HTTPS** | https://db.voltaireun.local | 200 OK | 222 ms | HTTP 200 via curl |
...
*Report archived in: C:\Users\waltd\OneDrive\Mediastack\handoffs\Proxy_Port_Diagnostic_Report_20260904_184905.md*
