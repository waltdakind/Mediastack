...
| Parameter | Value |
| :--- | :--- |
| **Audit Timestamp** | 2026-08-29 23:38:24 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Sonarr API | http://localhost:8989/api/v3/system/status | OK | 200 | 60ms | version: 4.0.19.2979 |
| Radarr API | http://localhost:7878/api/v3/system/status | OK | 200 | 7ms | version: 6.3.0.10514 |
| Prowlarr API | http://localhost:9696/api/v1/system/status | OK | 200 | 11ms | version: 2.5.2.5491 |
...
| AcoustID API | https://api.acoustid.org/v2/user/lookup?user=4wzgif6hwM | OK | 200 | 1117ms | status: ok |
| API Gateway | http://localhost:3000/api/system/status | OK | 200 | 87ms | HTTP 200 OK |
