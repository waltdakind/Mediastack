...
| Parameter | Value |
| :--- | :--- |
| **Audit Timestamp** | 2026-08-29 21:38:46 |
...
| Radarr API | http://localhost:7878/api/v3/system/status | OK | 200 | 35ms | version: 6.3.0.10514 |
| Prowlarr API | http://localhost:9696/api/v1/system/status | FAIL | FAIL | 73ms | The remote server returned an error: (500) Internal Server Error. |
| Bazarr API | http://localhost:6767/api/system/status | OK | 200 | 81ms | HTTP 200 OK |
| Jellyseerr API | http://localhost:5055/api/v1/status | OK | 200 | 31ms | version: 3.4.1 |
| Jellyfin API | http://localhost:8096/System/Info/Public | OK | 200 | 49ms | Version: 10.11.11 |
...
| AcoustID API | https://api.acoustid.org/v2/user/lookup?user=4wzgif6hwM | OK | 200 | 1534ms | status: ok |
| API Gateway | http://localhost:3000/api/system/status | OK | 200 | 79ms | HTTP 200 OK |
