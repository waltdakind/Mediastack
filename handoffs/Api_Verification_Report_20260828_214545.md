...
| Parameter | Value |
| :--- | :--- |
| **Audit Timestamp** | 2026-08-28 21:45:45 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Sonarr API | http://localhost:80/api/v3/system/status | OK | 200 | 53ms | version: 4.0.19.2979 |
...
| Jellyseerr API | http://localhost:80/api/v1/status | OK | 200 | 17ms | version: 3.4.1 |
| Jellyfin API | http://localhost:80/System/Info/Public | OK | 200 | 6ms | Version: 10.11.11 |
| MusicBrainz WS2 | http://localhost:80/ws/2/artist/5b11f4ce-a62d-471e-81fc-a69a8278c7da?fmt=json | FAIL | FAIL | 462ms | The remote server returned an error: (500) Internal Server Error. |
...
| API Gateway | http://localhost:80/api/system/status | OK | 200 | 105ms | HTTP 200 OK |
