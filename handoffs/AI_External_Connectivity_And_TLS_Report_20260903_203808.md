...
| :--- | :--- | :---: |
| **Audit Timestamp** | 2026-09-03 20:38:08 | PASS |
| **Host Node** | **VOLTAIREUN** | PASS |
| **Public WAN IP** | $wanIp | ACTIVE |
| **Domain Resolution** | $ddnsDomain -> $ddnsIp | RESOLVED |
| **TLS Certificate Status** | VALID (Expires in 3647.8 days) | VALID |
...
| **Validity Horizon** | 2026-09-01 to **2036-08-29** | **3647.8 days** remaining |
...
| :--- | :--- | :---: | :---: | :---: |
| **MusicBrainz API** | [API Endpoint](https://musicbrainz.org/ws/2/artist/f27ec8db-af05-4f36-916e-3d57f91ecf5e?fmt=json) | HTTP 200 | $(@{Name=MusicBrainz API; Url=https://musicbrainz.org/ws/2/artist/f27ec8db-af05-4f36-916e-3d57f91ecf5e?fmt=json; Code=200; Latency=410 ms; Healthy=True}.Latency) | Healthy (PASS) |
| **AcoustID API** | [API Endpoint](https://api.acoustid.org/v2/lookup) | HTTP 0 | $(@{Name=AcoustID API; Url=https://api.acoustid.org/v2/lookup; Code=0; Latency=255 ms; Healthy=False}.Latency) | Offline (FAIL) |
| **TheMovieDB (TMDB)** | [API Endpoint](https://api.themoviedb.org/3/configuration) | HTTP 0 | $(@{Name=TheMovieDB (TMDB); Url=https://api.themoviedb.org/3/configuration; Code=0; Latency=96 ms; Healthy=False}.Latency) | Offline (FAIL) |
| **Sonarr Skyhook** | [API Endpoint](https://skyhook.sonarr.tv/v1/tvdb/shows/en/71663) | HTTP 200 | $(@{Name=Sonarr Skyhook; Url=https://skyhook.sonarr.tv/v1/tvdb/shows/en/71663; Code=200; Latency=123 ms; Healthy=True}.Latency) | Healthy (PASS) |
| **Radarr Cloud API** | [API Endpoint](https://radarr.servarr.com/v1/update) | HTTP 0 | $(@{Name=Radarr Cloud API; Url=https://radarr.servarr.com/v1/update; Code=0; Latency=102 ms; Healthy=False}.Latency) | Offline (FAIL) |
| **GitHub Releases** | [API Endpoint](https://api.github.com/zen) | HTTP 200 | $(@{Name=GitHub Releases; Url=https://api.github.com/zen; Code=200; Latency=114 ms; Healthy=True}.Latency) | Healthy (PASS) |
...
| **Caddy Fallback HTTPS (:444)** | :444 | $(@{Name=Caddy Fallback HTTPS (:444); Host=127.0.0.1; Port=444; Success=False; Protocol=None; Cipher=None; Error=Exception calling "AuthenticateAsClient" with "1" argument(s): "Authentication failed because the remote party has closed the transport stream."}.Protocol) | $(@{Name=Caddy Fallback HTTPS (:444); Host=127.0.0.1; Port=444; Success=False; Protocol=None; Cipher=None; Error=Exception calling "AuthenticateAsClient" with "1" argument(s): "Authentication failed because the remote party has closed the transport stream."}.Cipher) | **FAILED** |
