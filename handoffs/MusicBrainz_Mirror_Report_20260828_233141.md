...
| Parameter | Value |
| :--- | :--- |
| **Audit Timestamp** | 2026-08-28 23:31:41 |
| **Host Node** | VOLTAIREDEUX |
| **Picard Target** | 192.168.4.21:5000 |
| **Caddy Proxy Route** | http://musicbrainz.voltaireun.local (Code: 200) |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| Local Primary Mirror | 127.0.0.1:5001 | OPEN | 500 | 500 | 14ms | STANDBY | Database Tables Pending Import |
| Remote Fallback Mirror | 192.168.4.21:5000 | OPEN | 000 | 200 | 9ms | READY | WS/2 Queries Operational |
