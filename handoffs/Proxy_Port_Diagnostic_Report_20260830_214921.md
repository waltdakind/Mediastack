...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Caddy Gateway HTTP** | 80 | caddy | INGRESS | **YES** | ONLINE | 19 ms | Operating normally |
...
| **Syncthing Web GUI** | 8384 | syncthing | SYNC | No | STANDBY | 1204 ms | Standby / optional node service not currently active. |
...
| :--- | :--- | :--- | :--- | :--- |
| **Dashboard Ingress HTTP** | http://voltairedeux.local | 302 OK | 98 ms | HTTP 302 via curl |
| **Dashboard Ingress HTTPS** | https://voltairedeux.local | 302 OK | 97 ms | HTTP 302 via curl |
| **Jellyfin Subdomain HTTP** | http://jellyfin.voltairedeux.local | 302 OK | 1158 ms | HTTP 302 (Caddy Gateway Verified) |
| **Jellyfin Subdomain HTTPS** | https://jellyfin.voltairedeux.local | 302 OK | 67 ms | HTTP 302 (Caddy Gateway Verified) |
| **Sonarr Subdomain HTTPS** | https://sonarr.voltairedeux.local | 401 OK | 962 ms | HTTP 401 (Caddy Gateway Verified) |
| **Radarr Subdomain HTTPS** | https://radarr.voltairedeux.local | 302 OK | 1387 ms | HTTP 302 (Caddy Gateway Verified) |
| **Prowlarr Subdomain HTTPS** | https://prowlarr.voltairedeux.local | 302 OK | 1181 ms | HTTP 302 (Caddy Gateway Verified) |
| **Bazarr Subdomain HTTPS** | https://bazarr.voltairedeux.local | 200 OK | 835 ms | HTTP 200 (Caddy Gateway Verified) |
| **Jellyseerr Route HTTPS** | https://jellyseerr.voltairedeux.local | 307 OK | 570 ms | HTTP 307 (Caddy Gateway Verified) |
| **API Gateway Route HTTPS** | https://api.voltairedeux.local | 308 OK | 772 ms | HTTP 308 (Caddy Gateway Verified) |
| **Database GUI Route HTTPS** | https://db.voltairedeux.local | 0 WARN | 962 ms | HTTP 0 via curl |
...
*Report archived in: C:\Users\waltd\OneDrive\Mediastack\handoffs\Proxy_Port_Diagnostic_Report_20260830_214921.md*
