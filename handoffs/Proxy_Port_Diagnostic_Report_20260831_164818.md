...
| **Transmission Peer TCP** | 51413 | transmission | TORRENT | No | STANDBY | 1216 ms | Standby / optional node service not currently active. |
...
| **Syncthing Peer TCP** | 22000 | syncthing | SYNC | No | STANDBY | 1209 ms | Standby / optional node service not currently active. |
| **MusicBrainz Secondary** | 5001 | musicbrainz | METADATA | No | ONLINE | 0 ms | Operating normally |
| **MusicBrainz Primary** | 5000 | remote | METADATA | No | ONLINE | 14 ms | Operating normally |
...
| :--- | :--- | :--- | :--- | :--- |
| **Dashboard Ingress HTTP** | http://voltairedeux.local | 302 OK | 89 ms | HTTP 302 via curl |
| **Dashboard Ingress HTTPS** | https://voltairedeux.local | 302 OK | 70 ms | HTTP 302 via curl |
| **Jellyfin Subdomain HTTP** | http://jellyfin.voltairedeux.local | 302 OK | 949 ms | HTTP 302 (Caddy Gateway Verified) |
| **Jellyfin Subdomain HTTPS** | https://jellyfin.voltairedeux.local | 302 OK | 32 ms | HTTP 302 (Caddy Gateway Verified) |
| **Sonarr Subdomain HTTPS** | https://sonarr.voltairedeux.local | 401 OK | 947 ms | HTTP 401 (Caddy Gateway Verified) |
| **Radarr Subdomain HTTPS** | https://radarr.voltairedeux.local | 302 OK | 952 ms | HTTP 302 (Caddy Gateway Verified) |
| **Prowlarr Subdomain HTTPS** | https://prowlarr.voltairedeux.local | 302 OK | 912 ms | HTTP 302 (Caddy Gateway Verified) |
| **Bazarr Subdomain HTTPS** | https://bazarr.voltairedeux.local | 200 OK | 953 ms | HTTP 200 (Caddy Gateway Verified) |
| **Jellyseerr Route HTTPS** | https://jellyseerr.voltairedeux.local | 307 OK | 957 ms | HTTP 307 (Caddy Gateway Verified) |
| **API Gateway Route HTTPS** | https://api.voltairedeux.local | 308 OK | 958 ms | HTTP 308 (Caddy Gateway Verified) |
| **Database GUI Route HTTPS** | https://db.voltairedeux.local | 200 OK | 954 ms | HTTP 200 (Caddy Gateway Verified) |
...
*Report archived in: C:\Users\waltd\OneDrive\Mediastack\handoffs\Proxy_Port_Diagnostic_Report_20260831_164818.md*
