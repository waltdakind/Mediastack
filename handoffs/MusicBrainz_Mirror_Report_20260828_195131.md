...
| Parameter | Value |
| :--- | :--- |
| **Audit Timestamp** | 2026-08-28 19:51:31 |
| **Host Node** | VOLTAIREDEUX |
| **Picard Target** | 192.168.4.30:5001 |
| **Caddy Proxy Route** | http://musicbrainz.ordinateur.local (Code: 000) |
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| Local Primary Mirror | 127.0.0.1:5001 | OPEN | 500 | 500 | 30ms | STANDBY | Database Tables Pending Import |
| Remote Fallback Mirror | 192.168.4.21:5000 | OPEN | 200 | 200 | 11ms | READY | WS/2 Queries Operational |
