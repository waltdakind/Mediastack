...
- Container 'homepage' is stopped. Last log snippet: [2026-08-30T01:21:59.694Z] [31merror[39m: Host validation failed for: voltaireun.local. Hint: Set the HOMEPAGE_ALLOWED_HOSTS environment variable to allow requests from this host / port. [2026-08-30T01:23:22.171Z] [31merror[39m: Host validation failed for: voltaireun.local. Hint: Set the HOMEPAGE_ALLOWED_HOSTS environment variable to allow requests from this host / port. [2026-08-30T01:24:36.021Z] [31merror[39m: Host validation failed for: voltaireun.local. Hint: Set the HOMEPAGE_ALLOWED_HOSTS environment variable to allow requests from this host / port.
