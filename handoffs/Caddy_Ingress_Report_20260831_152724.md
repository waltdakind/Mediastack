...
- **Execution Timestamp:** 2026-08-31 15:27:22
...
| HTTP Root Ingress (:80 -> HTTPS 301) | HTTP -> HTTPS (301 Redirect) | STANDBY |
...
| Internal LAN HTTP -> HTTPS Redirect (voltaireun.local) | HTTP -> HTTPS (301 Redirect) | STANDBY |
