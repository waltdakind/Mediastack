...
| **Transmission Peer TCP** | 51413 | transmission | TORRENT | No | STANDBY | 1205 ms | Standby / optional node service not currently active. |
...
| **Syncthing Web GUI** | 8384 | syncthing | SYNC | No | STANDBY | 1210 ms | Standby / optional node service not currently active. |
| **Syncthing Peer TCP** | 22000 | syncthing | SYNC | No | STANDBY | 1214 ms | Standby / optional node service not currently active. |
| **MusicBrainz Secondary** | 5001 | musicbrainz | METADATA | No | STANDBY | 1203 ms | Standby / optional node service not currently active. |
| **MusicBrainz Primary** | 5000 | remote | METADATA | No | ONLINE | 463 ms | Operating normally |
...
| :--- | :--- | :--- | :--- | :--- |
| **Dashboard Ingress HTTP** | http://voltairedeux.local | 200 OK | 103 ms | HTTP 200 via curl |
| **Dashboard Ingress HTTPS** | https://voltairedeux.local | 200 OK | 102 ms | HTTP 200 via curl |
| **Jellyfin Subdomain HTTP** | http://jellyfin.voltairedeux.local | 302 OK | 754 ms | HTTP 302 (Caddy Gateway Verified) |
| **Jellyfin Subdomain HTTPS** | https://jellyfin.voltairedeux.local | 302 OK | 54 ms | HTTP 302 (Caddy Gateway Verified) |
| **Sonarr Subdomain HTTPS** | https://sonarr.voltairedeux.local | 401 OK | 745 ms | HTTP 401 (Caddy Gateway Verified) |
| **Radarr Subdomain HTTPS** | https://radarr.voltairedeux.local | 302 OK | 746 ms | HTTP 302 (Caddy Gateway Verified) |
| **Prowlarr Subdomain HTTPS** | https://prowlarr.voltairedeux.local | 302 OK | 746 ms | HTTP 302 (Caddy Gateway Verified) |
| **Bazarr Subdomain HTTPS** | https://bazarr.voltairedeux.local | 200 OK | 748 ms | HTTP 200 (Caddy Gateway Verified) |
| **Jellyseerr Route HTTPS** | https://jellyseerr.voltairedeux.local | 307 OK | 724 ms | HTTP 307 (Caddy Gateway Verified) |
| **API Gateway Route HTTPS** | https://api.voltairedeux.local | 308 OK | 738 ms | HTTP 308 (Caddy Gateway Verified) |
| **Database GUI Route HTTPS** | https://db.voltairedeux.local | 200 OK | 727 ms | HTTP 200 (Caddy Gateway Verified) |
...
*Report archived in: C:\Users\waltd\OneDrive\Mediastack\handoffs\Proxy_Port_Diagnostic_Report_20260830_191636.md*
