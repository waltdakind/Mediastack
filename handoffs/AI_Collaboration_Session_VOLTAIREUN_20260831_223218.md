...
- **Execution Time:** 2026-08-31 22:32:18
...
| radarr.db | 1064 | Yes | 4023.5 | [WARN] CORRUPT |
| prowlarr.db | 336 | Yes | 72.5 | [WARN] CORRUPT |
...
- Container 'kind_hawking' is stopped. Last log snippet: Could not create config directory /app/config: ENOENT: no such file or directory, mkdir '/app/config' Could not create config directory /app/config: ENOENT: no such file or directory, mkdir '/app/config' Could not create config directory /app/config: ENOENT: no such file or directory, mkdir '/app/config'
- Container 'competent_mcnulty' is stopped. Last log snippet: 
