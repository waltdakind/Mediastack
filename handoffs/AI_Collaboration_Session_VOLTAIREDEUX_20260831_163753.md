...
- **Execution Time:** 2026-08-31 16:37:53
...
| :--- | :---: | :---: | :---: | :---: |
| `sonarr.db` | 2904 | Yes | 3238.9 | PRISTINE |
| `radarr.db` | 896 | Yes | 2345.7 | PRISTINE |
| `prowlarr.db` | 268 | No | 0 | PRISTINE |
| `bazarr.db` | 316 | Yes | 120.7 | PRISTINE |
| `db.sqlite3` | 220 | Yes | 221.3 | PRISTINE |
| `jellyfin.db` | 60996 | Yes | 0 | PRISTINE |
...
- [Caddy_Ingress_Report_20260831_163824.md] - **Routing Policy:** Direct ALL incoming root traffic to Jellyfin with automatic dual-node failover.
- [Caddy_Ingress_Report_20260831_163758.md] - **Routing Policy:** Direct ALL incoming root traffic to Jellyfin with automatic dual-node failover.
- [Caddy_Ingress_Report_20260831_163755.md] - **Routing Policy:** Direct ALL incoming root traffic to Jellyfin with automatic dual-node failover.
- [Caddy_Ingress_Report_20260831_163728.md] - **Routing Policy:** Direct ALL incoming root traffic to Jellyfin with automatic dual-node failover.
