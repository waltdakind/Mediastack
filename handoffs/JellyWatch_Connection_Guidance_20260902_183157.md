...
- **Timestamp:** 2026-09-02 18:31:57
- **Primary Live Route:** VoltaireUn Direct Socket (Primary LAN) (http://192.168.4.21:8096) - Latency: 192 ms
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | VoltaireUn Direct Socket (Primary LAN) | http://192.168.4.21:8096 | HTTP/REST | [OK] ONLINE | 192 ms | Apple Watch on Home WiFi (Zero TLS handshake friction, lowest latency) |
| 2 | VoltaireUn Ingress Gateway (Caddy HTTPS) | https://voltaireun.local | HTTPS/HTTP2 | [OK] ONLINE | 719 ms | LAN Web Companion & Ingress with Caching |
| 3 | VoltaireDeux AI Node (Failover LAN) | http://192.168.4.30:8096 | HTTP/REST | [!] UNREACHABLE | 1824 ms | Automated Failover when VoltaireUn is restarting/updating |
| 4 | Remote WAN Gateway (Public DDNS) | https://waltdakind.xubi.org | HTTPS/WAN | [OK] ONLINE | 135 ms | Apple Watch on LTE/Cellular or Out-of-Home Remote Streaming |
| 5 | Localhost Loopback Socket | http://127.0.0.1:8096 | HTTP/Loopback | [OK] ONLINE | 561 ms | Local Server Diagnostic & Docker Host Testing |
