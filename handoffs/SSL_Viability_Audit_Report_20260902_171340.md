...
| Metric | Value |
| :--- | :--- |
| **Timestamp** | 2026-09-02 17:13:40 |
| **Viability Score** | **75%** (DEGRADED / REPAIR NEEDED) |
| **Viable for Serving HTTPS** | **NO (Repair Required)** |
| **Primary Domain** | `waltdakind.xubi.org` |
| **Certificate Valid Until** | 2036-08-29 15:44:08 (3648 days remaining) |
| **Key Strength** | 4096-bit RSA (sha256RSA) |
| **Windows Trust Store** | INSTALLED & TRUSTED |
| **Live HTTPS :443 Handshake** | HTTP 0 (0 ms) |
