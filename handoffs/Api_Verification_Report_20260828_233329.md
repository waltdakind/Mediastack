...
| Parameter | Value |
| :--- | :--- |
| **Audit Timestamp** | 2026-08-28 23:33:29 |
...
| Radarr API | http://localhost:7878/api/v3/system/status | OK | 200 | 8ms | version: 6.3.0.10514 |
| Prowlarr API | http://localhost:9696/api/v1/system/status | OK | 200 | 16ms | version: 2.5.2.5491 |
| Bazarr API | http://localhost:6767/api/system/status | OK | 200 | 5ms | HTTP 200 OK |
| Jellyseerr API | http://localhost:5055/api/v1/status | OK | 200 | 15ms | version: 3.4.1 |
| Jellyfin API | http://localhost:8096/System/Info/Public | OK | 200 | 5ms | Version: 10.11.11 |
...
| AcoustID API | https://api.acoustid.org/v2/user/lookup?user=4wzgif6hwM | OK | 200 | 197ms | status: ok |
| API Gateway | http://localhost:3000/api/system/status | OK | 200 | 90ms | HTTP 200 OK |
| SQLite DB Web | http://localhost:8080/ | OK | 200 | 24ms | HTTP 200 OK (HTML/Text) |
