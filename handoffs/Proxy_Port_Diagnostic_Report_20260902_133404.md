...
| **MusicBrainz Primary** | 5000 | remote | METADATA | No | ONLINE | 1216 ms | Operating normally |
...
| :--- | :--- | :--- | :--- | :--- |
| **Dashboard Ingress HTTP** | http://voltairedeux.local | 301 OK | 99 ms | HTTP 301 via curl |
| **Dashboard Ingress HTTPS** | https://voltairedeux.local | 302 OK | 104 ms | HTTP 302 via curl |
| **Jellyfin Subdomain HTTP** | http://jellyfin.voltairedeux.local | 301 OK | 2064 ms | HTTP 301 (Caddy Gateway Verified) |
| **Jellyfin Subdomain HTTPS** | https://jellyfin.voltairedeux.local | 301 OK | 2053 ms | HTTP 301 (Caddy Gateway Verified) |
| **Sonarr Subdomain HTTPS** | https://sonarr.voltairedeux.local | 301 OK | 2061 ms | HTTP 301 (Caddy Gateway Verified) |
| **Radarr Subdomain HTTPS** | https://radarr.voltairedeux.local | 301 OK | 2058 ms | HTTP 301 (Caddy Gateway Verified) |
| **Prowlarr Subdomain HTTPS** | https://prowlarr.voltairedeux.local | 301 OK | 2057 ms | HTTP 301 (Caddy Gateway Verified) |
| **Bazarr Subdomain HTTPS** | https://bazarr.voltairedeux.local | 301 OK | 2058 ms | HTTP 301 (Caddy Gateway Verified) |
| **Jellyseerr Route HTTPS** | https://jellyseerr.voltairedeux.local | 301 OK | 2059 ms | HTTP 301 (Caddy Gateway Verified) |
| **API Gateway Route HTTPS** | https://api.voltairedeux.local | 308 OK | 2059 ms | HTTP 308 (Caddy Gateway Verified) |
| **Database GUI Route HTTPS** | https://db.voltairedeux.local | 301 OK | 2060 ms | HTTP 301 (Caddy Gateway Verified) |
...
*Report archived in: C:\Users\waltd\OneDrive\Mediastack\handoffs\Proxy_Port_Diagnostic_Report_20260902_133404.md*
