...
| :--- | :--- | :--- | :--- | :--- |
| Gateway / Router | 192.168.4.1 | âŒ Fail | 80 | âš ï¸ Closed |
| Local Node (VoltaireDeux) | 192.168.4.30 | âŒ Fail | 80 | âœ… Open |
| Primary Server (OrdinateurdeVolt) | 192.168.4.21 | âŒ Fail | 8096 | âœ… Open |
