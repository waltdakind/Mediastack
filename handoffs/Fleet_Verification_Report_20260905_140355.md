...
| Containers | Container: caddy | PASS | Status: RUNNING (Started: 2026-09-05T16:55:06.931034925Z) |
...
| Containers | Container: tdarr | PASS | Status: RUNNING (Started: 2026-09-05T16:43:24.467894404Z) |
| Containers | Container: qbittorrent | PASS | Status: RUNNING (Started: 2026-09-05T16:51:01.890582658Z) |
| HTTP | Caddy Reverse Proxy | PASS | HTTP 301 (TTFB: 38.6ms) |
| HTTP | Jellyfin Stream | PASS | HTTP 307 (TTFB: 15.8ms) |
| HTTP | Sonarr TV Manager | PASS | HTTP 200 (TTFB: 10.4ms) |
| HTTP | Radarr Movies | PASS | HTTP 200 (TTFB: 4.7ms) |
| HTTP | Prowlarr Indexers | PASS | HTTP 200 (TTFB: 7.5ms) |
| HTTP | Bazarr Subtitles | PASS | HTTP 200 (TTFB: 6.6ms) |
| HTTP | Seerr Requests | PASS | HTTP 200 (TTFB: 4.7ms) |
| HTTP | Syncthing P2P Mesh | PASS | HTTP 200 (TTFB: 3.9ms) |
| HTTP | Transmission Web | PASS | HTTP 200 (TTFB: 2.7ms) |
| HTTP | qBittorrent WebUI | PASS | HTTP 200 (TTFB: 3.6ms) |
