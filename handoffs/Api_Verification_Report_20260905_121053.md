...
| Parameter | Value |
| :--- | :--- |
| **Audit Timestamp** | 2026-09-05 12:10:53 |
...
| :--- | :--- | :--- | :--- | :--- | :--- |
| Sonarr API | http://localhost:8989/api/v3/system/status | OK | 200 | 37ms | version: 4.0.19.2979 |
...
| Jellyfin HTTPS | https://localhost/System/Info/Public | OK | 200 | 26ms | HTTP 200 OK (HTML/Text) |
...
| AcoustID API | https://api.acoustid.org/v2/user/lookup?user=4wzgif6hwM | OK | 200 | 210ms | status: ok |
| API Gateway | http://localhost:3000/api/system/status | OK | 200 | 1956ms | HTTP 200 OK |
| SQLite DB Web | http://localhost:8080/ | OK | 200 | 53ms | HTTP 200 OK (HTML/Text) |
| HDHomeRun Tuner | http://localhost:80/discover.json | OK | 301 | 1ms | HTTP 301 OK (HTML/Text) |
| JellyWatch Requests API | http://localhost:3000/api/jellywatch/requests/stats | OK | 200 | 3ms | server: JellyWatch Requests Server |
