...
| **Prowlarr Indexer** | 9696 | prowlarr | INDEXER | **YES** | ONLINE | 9 ms | Operating normally |
...
| **Dashboard Ingress HTTPS** | https://voltaireun.local | 302 OK | 90 ms | HTTP 302 via curl |
| **Jellyfin Subdomain HTTP** | http://jellyfin.voltaireun.local | 301 OK | 69 ms | HTTP 301 via curl |
| **Jellyfin Subdomain HTTPS** | https://jellyfin.voltaireun.local | 200 OK | 95 ms | HTTP 200 via curl |
| **Sonarr Subdomain HTTPS** | https://sonarr.voltaireun.local | 401 OK | 202 ms | HTTP 401 via curl |
| **Radarr Subdomain HTTPS** | https://radarr.voltaireun.local | 302 OK | 126 ms | HTTP 302 via curl |
| **Prowlarr Subdomain HTTPS** | https://prowlarr.voltaireun.local | 302 OK | 122 ms | HTTP 302 via curl |
| **Bazarr Subdomain HTTPS** | https://bazarr.voltaireun.local | 200 OK | 140 ms | HTTP 200 via curl |
| **Jellyseerr Route HTTPS** | https://jellyseerr.voltaireun.local | 307 OK | 212 ms | HTTP 307 via curl |
| **API Gateway Route HTTPS** | https://api.voltaireun.local | 308 OK | 94 ms | HTTP 308 (Caddy Gateway Verified) |
| **Database GUI Route HTTPS** | https://db.voltaireun.local | 200 OK | 524 ms | HTTP 200 via curl |
...
*Report archived in: C:\Users\waltd\OneDrive\Mediastack\handoffs\Proxy_Port_Diagnostic_Report_20260904_185640.md*
