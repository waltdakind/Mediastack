...
**Audit Timestamp:** 2026-09-04 18:43:42 | **Engine:** Sync-MediaStackSecrets.ps1
...
| **Jellyfin (VoltaireUn Server ID)** | Server ID | 8096 | SECURED IN VAULT | `d9fa...7df9` |
| **Jellyfin (VoltaireDeux Server ID)** | Server ID | 8096 | SECURED IN VAULT | `d9fa...7df9` |
| **JellyWatch (Companion / App)** | Premium Code | 8096 | SECURED IN VAULT | `4f3e...2ca1` |
...
| **Network Sync Users** | SMB Credentials | 445 | SECURED IN VAULT | `medi...Volt` |
