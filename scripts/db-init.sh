...
printf "%s\n" "─────────────────────────────────────────────────────────────────────────────────────────────"
printf "%-45s  %-35s  %s\n" "C:\\Users\\waltd\\OneDrive\\Mediastack"          "/mediastack"                 "Read-Write"
printf "%-45s  %-35s  %s\n" "C:\\Users\\waltd\\OneDrive\\Mediastack\\backups"  "/mediastack/backups"         "Read-Write"
printf "%-45s  %-35s  %s\n" "C:\\Users\\waltd\\OneDrive\\Mediastack\\logs"     "/mediastack/logs"            "Read-Write"
printf "%-45s  %-35s  %s\n" "C:\\Users\\waltd\\OneDrive\\Mediastack\\scripts"  "/mediastack/scripts"         "Read-Only"
printf "%-45s  %-35s  %s\n" "C:\\Users\\waltd\\OneDrive\\Mediastack\\Music"    "/data/music  (jellyfin)"     "Read-Only"
printf "%-45s  %-35s  %s\n" "\\\\VoltaireUn\\MediaStack-Movies"                 "/data/movies (jellyfin)"     "Read-Only"
printf "%-45s  %-35s  %s\n" "                                              "    "/movies       (radarr)"      "Read-Write"
printf "%-45s  %-35s  %s\n" "\\\\VoltaireUn\\MediaStack-Shows"                  "/data/shows   (jellyfin)"    "Read-Only"
printf "%-45s  %-35s  %s\n" "                                              "    "/shows        (sonarr)"      "Read-Write"
printf "%-45s  %-35s  %s\n" "\\\\VoltaireUn\\MediaStack-Videos"                 "/data/videos  (jellyfin)"    "Read-Only"
printf "%-45s  %-35s  %s\n" "\\\\VoltaireUn\\MediaStack-Videos\\Record"         "/recordings (tvheadend)"     "Read-Write"
