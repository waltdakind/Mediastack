<#
.SYNOPSIS
    Sync-MediaStackPriorityHandoffs.ps1 - Master Priority Handoffs Sync Forwarder.
#>
[CmdletBinding()]
param(
...
$target = Join-Path $PSScriptRoot "sync-files\Sync-MediaStackPriorityHandoffs.ps1"
