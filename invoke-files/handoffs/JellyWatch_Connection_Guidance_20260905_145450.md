...
- **Timestamp:** 2026-09-05 14:54:50
- **Primary Live Route:** Remote WAN Gateway (Public DDNS - Main Login) (https://waltdakind.xubi.org) - Latency: 560 ms
...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | Remote WAN Gateway (Public DDNS - Main Login) | https://waltdakind.xubi.org | HTTPS/WAN | [OK] ONLINE | 560 ms | Primary Default Login (Anywhere, LTE/Cellular & External Networks) |
| 2 | VoltaireUn Direct Socket (Local Network Fallback) | http://192.168.4.21:8096 | HTTP/REST | [OK] ONLINE | 131 ms | Local Home Network Fallback (Zero TLS friction, lowest LAN latency) |
| 3 | VoltaireUn Ingress Gateway (Caddy HTTPS) | https://voltaireun.local | HTTPS/HTTP2 | [!] UNREACHABLE | 2700 ms | Local LAN Ingress & Web Companion |
| 4 | VoltaireDeux AI Node (Failover LAN) | http://192.168.4.30:8096 | HTTP/REST | [!] HTTP_ERROR (500) | 28 ms | Automated Failover when VoltaireUn is restarting/updating |
| 5 | Localhost Loopback Socket | http://127.0.0.1:8096 | HTTP/Loopback | [OK] ONLINE | 3 ms | Local Server Diagnostic & Docker Host Testing |
