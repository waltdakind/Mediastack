...
$targetContainers = @("caddy", "jellyfin", "sonarr", "radarr", "prowlarr", "bazarr", "jellyseerr", "syncthing", "transmission", "mediastack-db")
...
$endpoints = @(
    ...
    @{ Name="Jellyseerr Requests"; Port=5055; Path="/api/v1/status";     Expected=200; Host="jellyseerr.voltairedeux.local" },
