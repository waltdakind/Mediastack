...
try {
    ...
    $readmeLines = @(
        ...
        "   - Create and grant Read-Write access to media folders (`Music`, `TV`, `Videos`, `Radio`, `Podcasts`, `downloads`, `documents`).",
        "   - Configure SMB network shares (`\\<hostname>\\MediaStack-Music`, etc.).",
